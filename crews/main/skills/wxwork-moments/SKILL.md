...
脚本路径：`/<workspace>/crews/main/skills/wxwork-moments/scripts/post_moments.py`

### 纯文字

```bash
python3 /<workspace>/crews/main/skills/wxwork-moments/scripts/post_moments.py "正文内容"
```

### 图文（最多 9 张图）

```bash
python3 /<workspace>/crews/main/skills/wxwork-moments/scripts/post_moments.py "正文内容" /path/to/img1.jpg /path/to/img2.png
```

### 视频（1 个，≤ 30 秒，≤ 10MB）

```bash
python3 /<workspace>/crews/main/skills/wxwork-moments/scripts/post_moments.py "正文内容" /path/to/video.mp4
```
...
```bash
python3 /<workspace>/crews/main/skills/wxwork-moments/scripts/post_moments.py "推荐阅读" --link https://example.com/article "文章标题" /path/to/cover.jpg
```
